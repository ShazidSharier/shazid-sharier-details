            ...
            <div id="smooth-content">
                ...
                <div class="left-sidebar">
                    <div class="sidebar-header d-flex align-items-center justify-content-between">
                        <img src="{{ asset('/') }}portfolio/assets/images/shazid.png" alt="Logo">
                        <span class="designation">Php Designer & Developer With Laravel & VueJs</span>
                    </div>
                    <img class="me" src="{{ asset('/') }}portfolio/assets/images/shazid2.jpg" alt="Me">
                    <h2 class="email">drzratul@gmail.com</h2>
                    <h2 class="address">Basila, Dhaka</h2>
                    <p class="copyright">&copy; 2024 Shazid. All Rights Reserved</p>
                    ...
                    <div class="custom-container">
                        <div class="hero-content content-width">
                            <div class="section-header">
                                ...
                                <h1 class="scroll-animation" data-animation="fade_from_bottom">Say Hi from <span>Shazid</span>, Php Designer & Developer</h1>
                            </div>
                            <p class="scroll-animation" data-animation="fade_from_bottom">I am a Php devoloper $ designer with Laravel & Vue Js.I design and code beautifully simple things and i love what i do. Just simple like that!</p>
                            <a href="#portfolio"
                               class="go-to-project-btn scroll-to scroll-animation"
                               data-animation="rotate_up">
                                <img src="{{ asset('/') }}portfolio/assets/images/round-text.png" alt="Rounded text">
                    ...
                    <div class="custom-container">
                        <div class="resume-content content-width">
                            <div class="section-header">
                                ...
                                <h1 class="scroll-animation" data-animation="fade_from_bottom">Institute
                        ...
                        <div class="services-content content-width">
                            ...
                            <div class="services-items">
                                ...
                                <div class="service-item scroll-animation" data-animation="fade_from_bottom">
                                    ...
                                    <h2>Development</h2>
                                    <p>I build website go live with Laravel & Vue Js</p>
                        ...
                        <div class="skills-content content-width">
                            ...
                            <div class="row skills text-center">
                                <div class="col-md-3 scroll-animation" data-animation="fade_from_bottom">
                                    <div class="skill">
                                        <div class="skill-inner">
                                            <img src="{{ asset('/') }}portfolio/assets/images/laravel.png" alt="Laravel/PHP">
                                ...
                                <div class="col-md-3 scroll-animation" data-animation="fade_from_left">
                                    <div class="skill">
                                        <div class="skill-inner">
                                            <img src="{{ asset('/') }}portfolio/assets/images/php2.png" alt="Figma">
                                            <h1 class="percent">90%</h1>
                                        </div>
                                        <p class="name">Php</p>
                                    </div>
                                ...
                                <div class="col-md-3 scroll-animation" data-animation="fade_from_top">
                                    <div class="skill">
                                        <div class="skill-inner">
                                            <img src="{{ asset('/') }}portfolio/assets/images/v.png" alt="Webflow">
                                ...
                                <div class="col-md-3 scroll-animation" data-animation="fade_from_right">
                                    <div class="skill">
                                        <div class="skill-inner">
                                            <img src="{{ asset('/') }}portfolio/assets/images/ajax1.png" alt="React">
                                            <h1 class="percent">70%</h1>
                                        </div>
                                        <p class="name">Ajax</p>
                                    </div>
                                ...
                                <div class="col-md-3 scroll-animation" data-animation="fade_from_right">
                                    <div class="skill">
                                        <div class="skill-inner">
                                            <img src="{{ asset('/') }}portfolio/assets/images/html1.png" alt="React">
                                            <h1 class="percent">90%</h1>
                                        </div>
                                ...
                                <div class="col-md-3 scroll-animation" data-animation="fade_from_right">
                                    <div class="skill">
                                        <div class="skill-inner">
                                            <img src="{{ asset('/') }}portfolio/assets/images/css1.png" alt="React">
                                            <h1 class="percent">90%</h1>
                                        </div>
                                        <p class="name">Css</p>
                                    </div>
                            ...
                            <div class="row portfolio-items">
                                <div class="col-md-12 scroll-animation" data-animation="fade_from_bottom">
                                    <div class="portfolio-item portfolio-full">
                                        <div class="portfolio-item-inner">
                                            <a href="{{ asset('/') }}portfolio/assets/images/portfolio1.jpg" data-lightbox="example-1">
                                                <img src="{{ asset('/') }}portfolio/assets/images/portfolio1.jpg" alt="Portfolio">
                                            </a>
                                ...
                                <div class="col-md-6 scroll-animation" data-animation="fade_from_left">
                                    <div class="portfolio-item portfolio-half">
                                        <div class="portfolio-item-inner">
                                            <a href="{{ asset('/') }}portfolio/assets/images/portfolio2.jpg" data-lightbox="example-1">
                                                <img src="{{ asset('/') }}portfolio/assets/images/portfolio2.jpg" alt="Portfolio">
                                            </a>
                                ...
                                <div class="col-md-6 scroll-animation" data-animation="fade_from_right">
                                    <div class="portfolio-item portfolio-half">
                                        <div class="portfolio-item-inner">
                                            <a href="{{ asset('/') }}portfolio/assets/images/portfolio3.jpg" data-lightbox="example-1">
                                                <img src="{{ asset('/') }}portfolio/assets/images/portfolio3.jpg" alt="Portfolio">
                                            </a>
                                ...
                                <div class="col-md-12 scroll-animation" data-animation="fade_from_bottom">
                                    <div class="portfolio-item portfolio-half">
                                        <div class="portfolio-item-inner">
                                            <a href="{{ asset('/') }}portfolio/assets/images/portfolio4.jpg" data-lightbox="example-1">
                                                <img src="{{ asset('/') }}portfolio/assets/images/portfolio4.jpg" alt="Portfolio">
                                            </a>
                                ...
                                <div class="col-md-12 scroll-animation" data-animation="fade_from_bottom">
                                    <div class="portfolio-item portfolio-half">
                                        <div class="portfolio-item-inner">
                                            <a href="{{ asset('/') }}portfolio/assets/images/portfolio5.jpg" data-lightbox="example-1">
                                                <img src="{{ asset('/') }}portfolio/assets/images/portfolio5.jpg" alt="Portfolio">
                                            </a>
                        ...
                        <div class="testimonial-content content-width">
                            ...
                            <div class="testimonial-slider-wrap scroll-animation" data-animation="fade_from_bottom">
                                <div class="owl-carousel testimonial-slider owl-theme">
                                    <div class="testimonial-item">
                                        <div class="testimonial-item-inner">
                                            <div class="author d-flex align-items-center">
                                                <img src="{{ asset('/') }}portfolio/assets/images/testimonial-1.jpg" alt="Testimonial">
                                                <div class="right">
                                                    <h3>Paublo Dybala</h3>
                                                    <p class="designation">CEO of <span>IBM Global</span></p>
                                                </div>
                                            </div>
                                            <p>“Shazid - A Developer with the creativity, professional and
                                    ...
                                    <div class="testimonial-item">
                                        <div class="testimonial-item-inner">
                                            <div class="author d-flex align-items-center">
                                                <img src="{{ asset('/') }}portfolio/assets/images/testimonial-2.jpg" alt="Testimonial">
                                                <div class="right">
                                                    <h3>Christina Morillo</h3>
                                                    <p class="designation">Product Management of <span>Invision App Inc</span></p>
                                                </div>
                                            </div>
                                            <p>“Shazid was a real pleasure to work with and we look
                                    ...
                                    <div class="testimonial-item">
                                        <div class="testimonial-item-inner">
                                            <div class="author d-flex align-items-center">
                                                <img src="{{ asset('/') }}portfolio/assets/images/testimonial-3.jpg" alt="Testimonial">
                                                <div class="right">
                                                    <h3>Phil Foden</h3>
                                                    <p class="designation">Director of <span>Envato LLC</span></p>
                                                </div>
                                            </div>
                                            <p>“Extremely profressional and fast service!. Shazid is a master
                            ...
                            <div class="clients-logos">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-3 scroll-animation" data-animation="fade_from_left">
                                        <img src="{{ asset('/') }}portfolio/assets/images/client-1.png" alt="Client">
                                    </div>
                                    <div class="col-md-3 scroll-animation" data-animation="fade_from_bottom">
                                        <img src="{{ asset('/') }}portfolio/assets/images/client-2.png" alt="Client">
                                    </div>
                                    <div class="col-md-3 scroll-animation" data-animation="fade_from_top">
                                        <img src="{{ asset('/') }}portfolio/assets/images/client-3.png" alt="Client">
                                    </div>
                                    <div class="col-md-3 scroll-animation" data-animation="fade_from_right">
                                        <img src="{{ asset('/') }}portfolio/assets/images/client-4.png" alt="Client">
                                    </div>
                                    <div class="col-md-3 scroll-animation" data-animation="fade_from_left">
                                        <img src="{{ asset('/') }}portfolio/assets/images/client-5.png" alt="Client">
                                    </div>
                                    <div class="col-md-3 scroll-animation" data-animation="fade_from_bottom">
                                        <img src="{{ asset('/') }}portfolio/assets/images/client-6.png" alt="Client">
                                    </div>
                                    <div class="col-md-3 scroll-animation" data-animation="fade_from_top">
                                        <img src="{{ asset('/') }}portfolio/assets/images/client-7.png" alt="Client">
                                    </div>
                                    <div class="col-md-3 scroll-animation" data-animation="fade_from_right">
                                        <img src="{{ asset('/') }}portfolio/assets/images/client-8.png" alt="Client">
                                    </div>
                                </div>
                            </div>
